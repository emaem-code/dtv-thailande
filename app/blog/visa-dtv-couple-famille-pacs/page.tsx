    ...
    <article className="max-w-3xl mx-auto px-5 md:px-6 py-14 md:py-20 font-sans text-gray-300 leading-relaxed bg-[#0a0a0a]">
      ...
      <section className="mb-12" id="reconnaissance-unions">
        ...
        <figure className="my-8">
          <Image
            ...
            alt="Mariage reconnu : le conjoint se rattache au dossier du titulaire. PACS non reconnu : chaque adulte doit monter son propre dossier."
            width={1200}
            height={800}
            className="rounded-2xl border border-white/10"
          />
          <figcaption className="mt-3 text-sm text-gray-500">
            Mariés : le conjoint se rattache et n&apos;a aucune activité à justifier. Pacsés : deux dossiers indépendants, chacun avec sa propre voie d&apos;éligibilité. C&apos;est le document d&apos;état civil qui fait la différence.
          </figcaption>
        </figure>
      ...
      <section className="mb-12" id="parcours-administratif">
        ...
        <ol className="list-decimal pl-5 space-y-2 mb-6 text-gray-400 marker:text-white marker:font-bold">
          ...
          <li><strong>Au Consulat :</strong> Seconde légalisation du document et de sa traduction par <a href="https://www.thaiembassy.fr/fr/service-consulaire/legalisation/" target="_blank" rel="noopener noreferrer" className="text-fuchsia-400 hover:underline">l'Ambassade Royale de Thaïlande à Paris</a>.</li>
        </ol>
