...
export const blogPosts = [
  ...
  },
  {
    ...
    description: "La catégorie « conjoint et enfants accompagnants » du Visa DTV : un seul compte de 500 000 THB pour toute la famille mariée, et le blocage du PACS.",
    excerpt: "Un seul compte de 500 000 THB suffit pour une famille mariée : le conjoint et les enfants de moins de 20 ans déposent en tant qu'accompagnants. Le PACS, lui, n'ouvre aucun droit.",
    date: '17 Juin 2026',
