      ...
      <aside className="hidden lg:flex flex-col fixed top-0 left-0 w-64 h-screen border-r border-white/5 bg-[#0a0a0a]/80 backdrop-blur-xl z-[60] py-10 px-6 justify-between shadow-[10px_0_30px_rgba(0,0,0,0.5)]">
        <div className="flex flex-col gap-10">
          ...
          <nav className="flex flex-col gap-1.5">
            ...
            <Link href="/blog/fonds-bancaires-visa-dtv" className="text-left px-4 py-3 rounded-xl hover:bg-white/5 hover:text-white transition-all duration-300 text-sm font-medium text-gray-400 flex items-center gap-3">
